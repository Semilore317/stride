...
## Features  
- **Product Management:** Create, edit, and view products with complete CRUD functionality.  
- **Category Management:** Organize products efficiently using dedicated category endpoints.  
