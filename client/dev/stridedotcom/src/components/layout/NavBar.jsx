                        ...
                        <Sheet open={open} onOpenChange={setOpen}>
                            ...
                            <SheetContent side="right" className="bg-black text-white w-64">
                                <div className="flex flex-col gap-6 pt-6">
                                    <NavLink to="/features" mobile onClick={handleLinkClick}>
                                        All Products
                                    </NavLink>
...
const NavLink = ({ to, children, mobile = false, onClick }) => (
    <Link
      ...
      after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 hover:after:w-full after:bg-purple-500 after:transition-all after:duration-300
    `}
    >
        {children}
    </Link>
